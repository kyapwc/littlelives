...
> [!CAUTION]
> Have managed to convert the project to typescript (took around 1 and a half hours), can disregard above (however, only converted the project to typescript after 7:30pm). Please check commit history to see when the project was finished.
